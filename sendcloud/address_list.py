...
from .conf import member_list, member_update, member_get, member_add, member_delete
...
class SendCloudAddressList(APIBaseClass):
    def __init__(self, fail_silently=False, *args, **kwargs):
        mail_list_addr, member_addr = (
            kwargs.pop("mail_list_addr", None),
            kwargs.pop("member_addr", None),
        )
        try:
            self._mail_list_addr = mail_list_addr or getattr(settings, "MAIL_LIST")
